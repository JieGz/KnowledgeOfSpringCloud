package com.qiyue.mq.task.parser;
...
import com.qiyue.mq.task.autoconfigura.JobZookeeperProperties;
import com.qiyue.mq.task.enums.ElasticJobTypeEnum;
	...
	public void onApplicationEvent(ApplicationReadyEvent event) {
		try {
			...
			for(Iterator<?> it = beanMap.values().iterator(); it.hasNext();) {
				...
				String jobName = this.jobZookeeperProperties.getNamespace() + "." + clazz.getName();
				...
				String registerBeanName = clazz.getSimpleName() + "SpringJobScheduler";
