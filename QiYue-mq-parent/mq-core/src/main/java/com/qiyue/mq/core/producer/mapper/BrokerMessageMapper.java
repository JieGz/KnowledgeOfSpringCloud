package com.qiyue.mq.core.producer.mapper;
...
public interface BrokerMessageMapper {
    ...
    void changeBrokerMessageStatus(@Param("brokerMessageId") String brokerMessageId, @Param("brokerMessageStatus") String brokerMessageStatus,@Param("updateTime") LocalDateTime updateTime);
    ...
    int update4TryCount(@Param("brokerMessageId") String brokerMessageId, @Param("updateTime") LocalDateTime updateTime);
